...
pub struct AgentSettings {
    ...
    /// Allow chat to use filesystem/shell tools directly in the main process.
    #[serde(default)]
...
mod tests {
    ...
    fn provider_only_rerun_preserves_unrelated_settings() {
        ...
        let prior = Settings {
            ...
            channels: ChannelSettings {
                http_enabled: true,
                http_port: Some(crate::config::DEFAULT_HTTP_PORT),
                signal_enabled: true,
        ...
        assert_eq!(
            current.channels.http_port,
            Some(crate::config::DEFAULT_HTTP_PORT)
        );
