...
I18n.register('en', {
  ...
  // Restart Modal
  'restart.title': 'Restart SClaw Instance',
  'restart.description': 'Are you sure you want to restart SClaw? This will gracefully restart the process.',
  ...
  'restart.progressTitle': 'Restarting SClaw',
  ...
  'config.telegramOwnerHint': 'After saving, SClaw will show a one-time code. Send `/start CODE` to your bot in Telegram and SClaw will finish setup automatically.',
